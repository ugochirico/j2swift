...
public class JavaCharacter : JavaObject, JavaSerializable, JavaComparable {
  ...
  public static func valueOf(c:jchar) ->JavaCharacter?  {
    return jint(c) < 128 ? JavaCharacter.smallValueOf(c) : JavaCharacter(withjchar: c)
  }
  ...
  public static func toCodePoint(high:jchar, _ low:jchar) ->jint  {
    let h:jint = jint(jint(jint(high) & 0x3FF) << 10)
    let l:jint = jint(jint(low) & 0x3FF)
    return jint(h | l) + 0x10000
  }
  ...
  public override func equals(object:JavaObject?) ->jboolean  {
    return (object is JavaCharacter) && (((object as! JavaCharacter)).value == value)
  }
  ...
  public static func getName(codePoint:jint) ->String?  {
    try JavaCharacter.checkValidCodePoint(codePoint)
    if (JavaCharacter.getType(codePoint) == jint(JavaCharacter.UNASSIGNED)) {
      return nil
    }
  ...
  public static func getNumericValue(codePoint:jint) ->jint  {
    if (codePoint < 128) {
      if (jchar(codePoint) >= "0".asciiValue && jchar(codePoint) <= "9".asciiValue) {
        return jchar(codePoint) - "0".asciiValue
      }
      if (jchar(codePoint) >= "a".asciiValue && jchar(codePoint) <= "z".asciiValue) {
        return codePoint - jint(jint("a".asciiValue) - 10)
      }
      if (jchar(codePoint) >= "A".asciiValue && jchar(codePoint) <= "Z".asciiValue) {
        return codePoint - jint(jint("A".asciiValue) - 10)
      }
  ...
  public static func highSurrogate(codePoint:jint) ->jchar  {
    return jchar((jint(codePoint >> 10) + 0xd7c0))
  }

  public static func lowSurrogate(codePoint:jint) ->jchar  {
    return jchar((jint(codePoint & 0x3ff) | 0xdc00))
  }
  ...
  public static func isBmpCodePoint(codePoint:jint) ->jboolean  {
    return jchar(codePoint) >= JavaCharacter.MIN_VALUE && jchar(codePoint) <= JavaCharacter.MAX_VALUE
  }
  ...
  public static func reverseBytes(c:jchar) ->jchar  {
    return jchar((jint(jint(c) << 8) | jint(jint(c) >> 8)))
  }
...
public class JavaCharacter_UnicodeBlock : JavaCharacter_Subset {
  ...
  private static var BLOCKS:[JavaCharacter_UnicodeBlock?]? = [nil,JavaCharacter_UnicodeBlock.BASIC_LATIN,JavaCharacter_UnicodeBlock.LATIN_1_SUPPLEMENT,JavaCharacter_UnicodeBlock.LATIN_EXTENDED_A,JavaCharacter_UnicodeBlock.LATIN_EXTENDED_B,JavaCharacter_UnicodeBlock.IPA_EXTENSIONS,JavaCharacter_UnicodeBlock.SPACING_MODIFIER_LETTERS,JavaCharacter_UnicodeBlock.COMBINING_DIACRITICAL_MARKS,JavaCharacter_UnicodeBlock.GREEK,JavaCharacter_UnicodeBlock.CYRILLIC,JavaCharacter_UnicodeBlock.ARMENIAN,JavaCharacter_UnicodeBlock.HEBREW,JavaCharacter_UnicodeBlock.ARABIC,JavaCharacter_UnicodeBlock.SYRIAC,JavaCharacter_UnicodeBlock.THAANA,JavaCharacter_UnicodeBlock.DEVANAGARI,JavaCharacter_UnicodeBlock.BENGALI,JavaCharacter_UnicodeBlock.GURMUKHI,JavaCharacter_UnicodeBlock.GUJARATI,JavaCharacter_UnicodeBlock.ORIYA,JavaCharacter_UnicodeBlock.TAMIL,JavaCharacter_UnicodeBlock.TELUGU,JavaCharacter_UnicodeBlock.KANNADA,JavaCharacter_UnicodeBlock.MALAYALAM,JavaCharacter_UnicodeBlock.SINHALA,JavaCharacter_UnicodeBlock.THAI,JavaCharacter_UnicodeBlock.LAO,JavaCharacter_UnicodeBlock.TIBETAN,JavaCharacter_UnicodeBlock.MYANMAR,JavaCharacter_UnicodeBlock.GEORGIAN,JavaCharacter_UnicodeBlock.HANGUL_JAMO,JavaCharacter_UnicodeBlock.ETHIOPIC,JavaCharacter_UnicodeBlock.CHEROKEE,JavaCharacter_UnicodeBlock.UNIFIED_CANADIAN_ABORIGINAL_SYLLABICS,JavaCharacter_UnicodeBlock.OGHAM,JavaCharacter_UnicodeBlock.RUNIC,JavaCharacter_UnicodeBlock.KHMER,JavaCharacter_UnicodeBlock.MONGOLIAN,JavaCharacter_UnicodeBlock.LATIN_EXTENDED_ADDITIONAL,JavaCharacter_UnicodeBlock.GREEK_EXTENDED,JavaCharacter_UnicodeBlock.GENERAL_PUNCTUATION,JavaCharacter_UnicodeBlock.SUPERSCRIPTS_AND_SUBSCRIPTS,JavaCharacter_UnicodeBlock.CURRENCY_SYMBOLS,JavaCharacter_UnicodeBlock.COMBINING_MARKS_FOR_SYMBOLS,JavaCharacter_UnicodeBlock.LETTERLIKE_SYMBOLS,JavaCharacter_UnicodeBlock.NUMBER_FORMS,JavaCharacter_UnicodeBlock.ARROWS,JavaCharacter_UnicodeBlock.MATHEMATICAL_OPERATORS,JavaCharacter_UnicodeBlock.MISCELLANEOUS_TECHNICAL,JavaCharacter_UnicodeBlock.CONTROL_PICTURES,JavaCharacter_UnicodeBlock.OPTICAL_CHARACTER_RECOGNITION,JavaCharacter_UnicodeBlock.ENCLOSED_ALPHANUMERICS,JavaCharacter_UnicodeBlock.BOX_DRAWING,JavaCharacter_UnicodeBlock.BLOCK_ELEMENTS,JavaCharacter_UnicodeBlock.GEOMETRIC_SHAPES,JavaCharacter_UnicodeBlock.MISCELLANEOUS_SYMBOLS,JavaCharacter_UnicodeBlock.DINGBATS,JavaCharacter_UnicodeBlock.BRAILLE_PATTERNS,JavaCharacter_UnicodeBlock.CJK_RADICALS_SUPPLEMENT,JavaCharacter_UnicodeBlock.KANGXI_RADICALS,JavaCharacter_UnicodeBlock.IDEOGRAPHIC_DESCRIPTION_CHARACTERS,JavaCharacter_UnicodeBlock.CJK_SYMBOLS_AND_PUNCTUATION,JavaCharacter_UnicodeBlock.HIRAGANA,JavaCharacter_UnicodeBlock.KATAKANA,JavaCharacter_UnicodeBlock.BOPOMOFO,JavaCharacter_UnicodeBlock.HANGUL_COMPATIBILITY_JAMO,JavaCharacter_UnicodeBlock.KANBUN,JavaCharacter_UnicodeBlock.BOPOMOFO_EXTENDED,JavaCharacter_UnicodeBlock.ENCLOSED_CJK_LETTERS_AND_MONTHS,JavaCharacter_UnicodeBlock.CJK_COMPATIBILITY,JavaCharacter_UnicodeBlock.CJK_UNIFIED_IDEOGRAPHS_EXTENSION_A,JavaCharacter_UnicodeBlock.CJK_UNIFIED_IDEOGRAPHS,JavaCharacter_UnicodeBlock.YI_SYLLABLES,JavaCharacter_UnicodeBlock.YI_RADICALS,JavaCharacter_UnicodeBlock.HANGUL_SYLLABLES,JavaCharacter_UnicodeBlock.HIGH_SURROGATES,JavaCharacter_UnicodeBlock.HIGH_PRIVATE_USE_SURROGATES,JavaCharacter_UnicodeBlock.LOW_SURROGATES,JavaCharacter_UnicodeBlock.PRIVATE_USE_AREA,JavaCharacter_UnicodeBlock.CJK_COMPATIBILITY_IDEOGRAPHS,JavaCharacter_UnicodeBlock.ALPHABETIC_PRESENTATION_FORMS,JavaCharacter_UnicodeBlock.ARABIC_PRESENTATION_FORMS_A,JavaCharacter_UnicodeBlock.COMBINING_HALF_MARKS,JavaCharacter_UnicodeBlock.CJK_COMPATIBILITY_FORMS,JavaCharacter_UnicodeBlock.SMALL_FORM_VARIANTS,JavaCharacter_UnicodeBlock.ARABIC_PRESENTATION_FORMS_B,JavaCharacter_UnicodeBlock.SPECIALS,JavaCharacter_UnicodeBlock.HALFWIDTH_AND_FULLWIDTH_FORMS,JavaCharacter_UnicodeBlock.OLD_ITALIC,JavaCharacter_UnicodeBlock.GOTHIC,JavaCharacter_UnicodeBlock.DESERET,JavaCharacter_UnicodeBlock.BYZANTINE_MUSICAL_SYMBOLS,JavaCharacter_UnicodeBlock.MUSICAL_SYMBOLS,JavaCharacter_UnicodeBlock.MATHEMATICAL_ALPHANUMERIC_SYMBOLS,JavaCharacter_UnicodeBlock.CJK_UNIFIED_IDEOGRAPHS_EXTENSION_B,JavaCharacter_UnicodeBlock.CJK_COMPATIBILITY_IDEOGRAPHS_SUPPLEMENT,JavaCharacter_UnicodeBlock.TAGS,JavaCharacter_UnicodeBlock.CYRILLIC_SUPPLEMENTARY,JavaCharacter_UnicodeBlock.TAGALOG,JavaCharacter_UnicodeBlock.HANUNOO,JavaCharacter_UnicodeBlock.BUHID,JavaCharacter_UnicodeBlock.TAGBANWA,JavaCharacter_UnicodeBlock.MISCELLANEOUS_MATHEMATICAL_SYMBOLS_A,JavaCharacter_UnicodeBlock.SUPPLEMENTAL_ARROWS_A,JavaCharacter_UnicodeBlock.SUPPLEMENTAL_ARROWS_B,JavaCharacter_UnicodeBlock.MISCELLANEOUS_MATHEMATICAL_SYMBOLS_B,JavaCharacter_UnicodeBlock.SUPPLEMENTAL_MATHEMATICAL_OPERATORS,JavaCharacter_UnicodeBlock.KATAKANA_PHONETIC_EXTENSIONS,JavaCharacter_UnicodeBlock.VARIATION_SELECTORS,JavaCharacter_UnicodeBlock.SUPPLEMENTARY_PRIVATE_USE_AREA_A,JavaCharacter_UnicodeBlock.SUPPLEMENTARY_PRIVATE_USE_AREA_B,JavaCharacter_UnicodeBlock.LIMBU,JavaCharacter_UnicodeBlock.TAI_LE,JavaCharacter_UnicodeBlock.KHMER_SYMBOLS,JavaCharacter_UnicodeBlock.PHONETIC_EXTENSIONS,JavaCharacter_UnicodeBlock.MISCELLANEOUS_SYMBOLS_AND_ARROWS,JavaCharacter_UnicodeBlock.YIJING_HEXAGRAM_SYMBOLS,JavaCharacter_UnicodeBlock.LINEAR_B_SYLLABARY,JavaCharacter_UnicodeBlock.LINEAR_B_IDEOGRAMS,JavaCharacter_UnicodeBlock.AEGEAN_NUMBERS,JavaCharacter_UnicodeBlock.UGARITIC,JavaCharacter_UnicodeBlock.SHAVIAN,JavaCharacter_UnicodeBlock.OSMANYA,JavaCharacter_UnicodeBlock.CYPRIOT_SYLLABARY,JavaCharacter_UnicodeBlock.TAI_XUAN_JING_SYMBOLS,JavaCharacter_UnicodeBlock.VARIATION_SELECTORS_SUPPLEMENT,JavaCharacter_UnicodeBlock.ANCIENT_GREEK_MUSICAL_NOTATION,JavaCharacter_UnicodeBlock.ANCIENT_GREEK_NUMBERS,JavaCharacter_UnicodeBlock.ARABIC_SUPPLEMENT,JavaCharacter_UnicodeBlock.BUGINESE,JavaCharacter_UnicodeBlock.CJK_STROKES,JavaCharacter_UnicodeBlock.COMBINING_DIACRITICAL_MARKS_SUPPLEMENT,JavaCharacter_UnicodeBlock.COPTIC,JavaCharacter_UnicodeBlock.ETHIOPIC_EXTENDED,JavaCharacter_UnicodeBlock.ETHIOPIC_SUPPLEMENT,JavaCharacter_UnicodeBlock.GEORGIAN_SUPPLEMENT,JavaCharacter_UnicodeBlock.GLAGOLITIC,JavaCharacter_UnicodeBlock.KHAROSHTHI,JavaCharacter_UnicodeBlock.MODIFIER_TONE_LETTERS,JavaCharacter_UnicodeBlock.NEW_TAI_LUE,JavaCharacter_UnicodeBlock.OLD_PERSIAN,JavaCharacter_UnicodeBlock.PHONETIC_EXTENSIONS_SUPPLEMENT,JavaCharacter_UnicodeBlock.SUPPLEMENTAL_PUNCTUATION,JavaCharacter_UnicodeBlock.SYLOTI_NAGRI,JavaCharacter_UnicodeBlock.TIFINAGH,JavaCharacter_UnicodeBlock.VERTICAL_FORMS,JavaCharacter_UnicodeBlock.NKO,JavaCharacter_UnicodeBlock.BALINESE,JavaCharacter_UnicodeBlock.LATIN_EXTENDED_C,JavaCharacter_UnicodeBlock.LATIN_EXTENDED_D,JavaCharacter_UnicodeBlock.PHAGS_PA,JavaCharacter_UnicodeBlock.PHOENICIAN,JavaCharacter_UnicodeBlock.CUNEIFORM,JavaCharacter_UnicodeBlock.CUNEIFORM_NUMBERS_AND_PUNCTUATION,JavaCharacter_UnicodeBlock.COUNTING_ROD_NUMERALS,JavaCharacter_UnicodeBlock.SUNDANESE,JavaCharacter_UnicodeBlock.LEPCHA,JavaCharacter_UnicodeBlock.OL_CHIKI,JavaCharacter_UnicodeBlock.CYRILLIC_EXTENDED_A,JavaCharacter_UnicodeBlock.VAI,JavaCharacter_UnicodeBlock.CYRILLIC_EXTENDED_B,JavaCharacter_UnicodeBlock.SAURASHTRA,JavaCharacter_UnicodeBlock.KAYAH_LI,JavaCharacter_UnicodeBlock.REJANG,JavaCharacter_UnicodeBlock.CHAM,JavaCharacter_UnicodeBlock.ANCIENT_SYMBOLS,JavaCharacter_UnicodeBlock.PHAISTOS_DISC,JavaCharacter_UnicodeBlock.LYCIAN,JavaCharacter_UnicodeBlock.CARIAN,JavaCharacter_UnicodeBlock.LYDIAN,JavaCharacter_UnicodeBlock.MAHJONG_TILES,JavaCharacter_UnicodeBlock.DOMINO_TILES,JavaCharacter_UnicodeBlock.SAMARITAN,JavaCharacter_UnicodeBlock.UNIFIED_CANADIAN_ABORIGINAL_SYLLABICS_EXTENDED,JavaCharacter_UnicodeBlock.TAI_THAM,JavaCharacter_UnicodeBlock.VEDIC_EXTENSIONS,JavaCharacter_UnicodeBlock.LISU,JavaCharacter_UnicodeBlock.BAMUM,JavaCharacter_UnicodeBlock.COMMON_INDIC_NUMBER_FORMS,JavaCharacter_UnicodeBlock.DEVANAGARI_EXTENDED,JavaCharacter_UnicodeBlock.HANGUL_JAMO_EXTENDED_A,JavaCharacter_UnicodeBlock.JAVANESE,JavaCharacter_UnicodeBlock.MYANMAR_EXTENDED_A,JavaCharacter_UnicodeBlock.TAI_VIET,JavaCharacter_UnicodeBlock.MEETEI_MAYEK,JavaCharacter_UnicodeBlock.HANGUL_JAMO_EXTENDED_B,JavaCharacter_UnicodeBlock.IMPERIAL_ARAMAIC,JavaCharacter_UnicodeBlock.OLD_SOUTH_ARABIAN,JavaCharacter_UnicodeBlock.AVESTAN,JavaCharacter_UnicodeBlock.INSCRIPTIONAL_PARTHIAN,JavaCharacter_UnicodeBlock.INSCRIPTIONAL_PAHLAVI,JavaCharacter_UnicodeBlock.OLD_TURKIC,JavaCharacter_UnicodeBlock.RUMI_NUMERAL_SYMBOLS,JavaCharacter_UnicodeBlock.KAITHI,JavaCharacter_UnicodeBlock.EGYPTIAN_HIEROGLYPHS,JavaCharacter_UnicodeBlock.ENCLOSED_ALPHANUMERIC_SUPPLEMENT,JavaCharacter_UnicodeBlock.ENCLOSED_IDEOGRAPHIC_SUPPLEMENT,JavaCharacter_UnicodeBlock.CJK_UNIFIED_IDEOGRAPHS_EXTENSION_C,JavaCharacter_UnicodeBlock.MANDAIC,JavaCharacter_UnicodeBlock.BATAK,JavaCharacter_UnicodeBlock.ETHIOPIC_EXTENDED_A,JavaCharacter_UnicodeBlock.BRAHMI,JavaCharacter_UnicodeBlock.BAMUM_SUPPLEMENT,JavaCharacter_UnicodeBlock.KANA_SUPPLEMENT,JavaCharacter_UnicodeBlock.PLAYING_CARDS,JavaCharacter_UnicodeBlock.MISCELLANEOUS_SYMBOLS_AND_PICTOGRAPHS,JavaCharacter_UnicodeBlock.EMOTICONS,JavaCharacter_UnicodeBlock.TRANSPORT_AND_MAP_SYMBOLS,JavaCharacter_UnicodeBlock.ALCHEMICAL_SYMBOLS,JavaCharacter_UnicodeBlock.CJK_UNIFIED_IDEOGRAPHS_EXTENSION_D]
  private static let blockAliasMap:JavaMap? = JavaHashMap()
