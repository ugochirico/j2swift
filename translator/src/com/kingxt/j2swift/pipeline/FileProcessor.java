...
package com.kingxt.j2swift.pipeline;
...
import com.kingxt.j2swift.ast.TreeConverter;
...
abstract class FileProcessor {
  ...
  private void processInput(ProcessingContext input) {
    ...
    try {
      ...
      source = source.replaceAll("import org.jetbrains.annotations.*;", "");
      source = source.replace("@NotNull", "");
      source = source.replace("@Nullable", "");
  ...
  private void processCompiledSource(ProcessingContext input, String source, CompilationUnit unit) {
    ...
    com.kingxt.j2swift.ast.CompilationUnit convertedUnit =
  ...
  protected abstract void processConvertedTree(
      ProcessingContext input, com.kingxt.j2swift.ast.CompilationUnit unit);
