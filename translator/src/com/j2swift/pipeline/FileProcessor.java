...
import com.j2swift.ast.TreeConverter;
import com.j2swift.file.InputFile;
import com.j2swift.util.ErrorUtil;
import com.j2swift.util.FileUtil;
...
abstract class FileProcessor {
  ...
  private void processCompiledSource(ProcessingContext input, String source, CompilationUnit unit) {
    ...
    com.j2swift.ast.CompilationUnit convertedUnit =
  ...
  protected abstract void processConvertedTree(
      ProcessingContext input, com.j2swift.ast.CompilationUnit unit);
